...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--with_CL', type=int, default=1, help='use cosine embedding loss for training')
    ...
    def parse(self):
        ...
        if self.isTrain:
            ...
            expr_dir = os.path.join(self.opt.results_dir, self.opt.name, '%s_%s' % (self.opt.phase, self.opt.which_epoch))
